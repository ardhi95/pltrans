...
<head>
	...
	<!-- FullCalendar -->
	<link href="<?=base_url()?>assets/front_end/css/fullcalendar.css" rel="stylesheet">
...
<body>
	...
	<!-- FullCalendar -->
	<script src='<?=base_url()?>assets/front_end/js/moment.min.js'></script>
	<script src='<?=base_url()?>assets/front_end/js/fullcalendar.min.js'></script>
	...
	$(document).ready(function() {
		...
		$('#calendar').fullCalendar({
			...
			defaultDate: '2016-01-12', // cek yang ini bro!
			editable: true,
